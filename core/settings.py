...
ALLOWED_HOSTS = ["localhost", "femi-portfolio-backend.herokuapp.com"]
...
GRAPHENE = {"MIDDELEWARE": ["graphql_jwt.middleware.JSONWebTokenMiddleware"]}

AUTHENTICATION_BACKENDS = [
    "grapql_jwt.backends.JSONWebTokenBackend",
    "django.contrib.auth.backends.ModelBackend",
]

CORS_ALLOWED_ORIGIN_REGEXES = [
    "http://localhost:3000",
    r"^https://(w{3}\.)?portfolio\.?\w+\.\w{2,}$",
]
